...
class ArticleInfo(models.Model):
    ...
    NewsPaper_UploadDate = models.CharField(max_length=100, blank=True, null=True)
    is_municipal_commissioner = models.CharField(max_length=100, blank=True, null=True)
